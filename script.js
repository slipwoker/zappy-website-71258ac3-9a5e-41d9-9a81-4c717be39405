      ...
      if (!window.zappyContactFormLoaded) {
        try {
          ...
          fetch('https://api.zappy5.com/api/email/contact-form', {
            ...
            body: JSON.stringify({
              websiteId: '71258ac3-9a5e-41d9-9a81-4c717be39405',
              name: name,
              email: email,
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "SKIPPERS - מתנות לסקיפרים- מתנות לימאים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
